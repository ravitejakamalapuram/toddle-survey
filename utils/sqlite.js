...
const init_tables = () => {
    db.serialize(function () {
        // surveys db
        db.run("CREATE TABLE IF NOT EXISTS surveys (survey_id text NOT NULL, question text, true integer DEFAULT 0, false integer DEFAULT 0)");
        ...
        for (let i = 1; i <= 10; i++) {
            ...
            // db.run(`INSERT INTO surveys VALUES('survey_${Math.floor(i / 10)}', 'question_${i}', 0, 0);`, function (err, res) { });
        }
    });
}
